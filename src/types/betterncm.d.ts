...
declare module "plugin" {
	...
	export interface LibLyricPlugin extends NCMPlugin {
		getLyricData: typeof import("..").getLyricData;
		parseLyric: typeof import("..").parseLyric;
		parsePureLyric: typeof import("..").parsePureLyric;
		parsePureDynamicLyric: typeof import("..").parsePureDynamicLyric;
	}
	...
	export class NCMInjectPlugin extends EventTarget {
		...
		mainPlugin: LibLyricPlugin;
		loadError: Error | null;
		finished: boolean;
		constructor(mainPlugin: LibLyricPlugin, filePath: string);
